...
class FabStyle extends ComponentStyle<FabStyle> with Breakpoints<FabStyle> implements FabStyling {
  ...
  const FabStyle(super.cssClass, {required super.type, super.modifiers});
...
/// Defines styling options for [FabAction], [FabClose], and [FabMainAction] wrappers.
class FabActionStyle extends ComponentStyle<FabActionStyle>
  ...
  const FabActionStyle(super.cssClass, {required super.type, super.modifiers});
